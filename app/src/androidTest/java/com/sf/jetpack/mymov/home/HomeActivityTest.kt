...
class HomeActivityTest {
    ...
    fun checkDetailMovie() {
        ...
        onView(withId(R.id.textMovieName)).check(matches(withText(dummyMovie[0].name)))
        onView(withId(R.id.textMovieDescription)).check(matches(withText(dummyMovie[0].description)))
    ...
    fun checkMovieTrailerNotFound() {
        ...
        onView(withId(R.id.textMovieName)).check(matches(isDisplayed()))
        onView(withId(R.id.textMovieName)).check(matches(withText(dummyMovie[3].name)))
        onView(withId(R.id.textMovieDescription)).check(matches(withText(dummyMovie[3].description)))
    ...
    fun checkDetailTvShow() {
        ...
        onView(withId(R.id.textMovieName)).check(matches(isDisplayed()))
        onView(withId(R.id.textMovieName)).check(matches(withText(dummyTvShow[0].name)))
        onView(withId(R.id.textMovieDescription)).check(matches(withText(dummyTvShow[0].description)))
    ...
    fun checkTvShowTrailerNotFound() {
        ...
        onView(withId(R.id.textMovieName)).check(matches(isDisplayed()))
        onView(withId(R.id.textMovieName)).check(matches(withText(dummyTvShow[4].name)))
        onView(withId(R.id.textMovieDescription)).check(matches(withText(dummyTvShow[4].description)))
